<html> 
<head> 
<title> Kanish group | Carving Wood </title>
...
<body>
	...
	<?php
		...
		$table = mysql_query("SELECT id, wood FROM carving ORDER BY id ASC");
		...
		while($row=mysql_fetch_array($table)){
			...
			echo "<li> <img src='../images/carving/$img' />  
				...
				<form action='remove_carvingWood.php?id=$id' name='remove' method='post' onsubmit='return(removeFun())'> <input type='submit' class='removeBtn' name='remove' value='REMOVE' /> </form> </li> 
			";
			}
	...
	?>
		...
		<?php
			...
			if(isset($_POST['submit'])){		
				...
				if (isset($fileName)){
					$upload = mysql_query("INSERT INTO carving (wood)VALUE('$fileName')");				
