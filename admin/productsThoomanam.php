...
<body>
	...
	<?php
		...
		$table = mysql_query("SELECT *FROM products WHERE thoomanam='thoomanam' ORDER BY id ASC"); 
		...
		while($row=mysql_fetch_array($table)){
			...
			echo "<li> <img src='../images/products/$img' />  
				...
				<form action='removeProductsThoomanam.php?id=$id' name='remove' method='post' onsubmit='return(removeFun())'> <input type='submit' class='removeBtn' name='remove' value='REMOVE' /> </form> </li> 
			";
	...
	?>
		...
		<?php
			...
			if(isset($_POST['submit'])){		
				...
				if (isset($fileName)){
					$upload = mysql_query("INSERT INTO products (thoomanam, image)VALUE('thoomanam','$fileName')");				
