<html> 
<head> 
<title> Kanish group | glass ceiling </title>
...
<body>
	...
	<?php
		...
		$table = mysql_query("SELECT *FROM printing WHERE glass='ceiling' ORDER BY id ASC");
		...
		while($row=mysql_fetch_array($table)){
			...
			echo "<li> <img src='../images/glass/$img' />  
				...
				<form action='removeGlassCeiling.php?id=$id' name='remove' method='post' onsubmit='return(removeFun())'> <input type='submit' class='removeBtn' name='remove' value='REMOVE' /> </form> </li> 
			";
