<html> 
<head> 
<title> Kanish group | glass door </title>
...
<body>
	...
	<?php
		...
		$table = mysql_query("SELECT *FROM printing WHERE glass='door' ORDER BY id ASC");
		...
		while($row=mysql_fetch_array($table)){
			...
			echo "<li> <img src='../images/glass/$img' />  
				...
				<form action='removeGlassDoor.php?id=$id' name='remove' method='post' onsubmit='return(removeFun())'> <input type='submit' class='removeBtn' name='remove' value='REMOVE' /> </form> </li> 
			";
	...
	?>
		...
		<?php
			...
			if(isset($_POST['submit'])){		
				...
				if (isset($fileName)){
					$upload = mysql_query("INSERT INTO printing (glass, image)VALUE('door','$fileName')");				
