<html> 
<head> 
<title> Kanish group | vbit carving </title>
...
<body>
	...
	<?php
		...
		$table = mysql_query("SELECT id, vbitcarving FROM carving ORDER BY id ASC");
		...
		while($row=mysql_fetch_array($table)){
			...
			echo "<li> <img src='../images/carving/$img' />  
				...
				<form action='remove_carvingVbitCarving.php?id=$id' name='remove' method='post' onsubmit='return(removeFun())'> <input type='submit' class='removeBtn' name='remove' value='REMOVE' /> </form> </li> 
			";
			}
	...
	?>
		...
		<?php
			...
			if(isset($_POST['submit'])){		
				...
				if (isset($fileName)){
					$upload = mysql_query("INSERT INTO carving (vbitcarving)VALUE('$fileName')");				
